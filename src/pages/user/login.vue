...
<div class="login">
    ...
    <div class="form">
		...
		<div class="group">
			<x-input v-model="pwd" placeholder="请输入6-20为登录密码" class="x-input" type="password">
    ...
    <div class="form-other">
      <router-link to="/user/forget"><span>忘记密码</span></router-link>
      <router-link to="/user/register"><span class="col-b">新用户注册</span></router-link>
    </div>
